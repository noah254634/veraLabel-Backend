...
router.post('/revoke-dataset-batches', protectRoute, tasksWriteLimiter, taskController.revokeDatasetBatches)
router.post('/revoke-expired-batches', protectRoute, tasksWriteLimiter, taskController.revokeExpiredBatchesGlobal)
router.post('/generate-missing-embeddings', protectRoute, tasksWriteLimiter, taskController.generateMissingEmbeddings)
